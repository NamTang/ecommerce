...
import com.example.ecommerce.repository.ProductTagRepository;
...
public class AdminProductController {
    ...
    public String addProductPost(@Valid @ModelAttribute("product") Product product, BindingResult result, HttpServletRequest request, Model model)
        ...
        if (product.getProductId() == null) {
            ...
            File theDir = new File(rootDirectory + "\\src\\main\\resources\\static\\images\\" + String.valueOf(product.getProductId()));
        ...
        path = Paths.get(rootDirectory + "\\src\\main\\resources\\static\\images\\" + product.getProductId() + "\\" + "0.png");
    ...
    @GetMapping("/d")
    public String deleteProduct(@RequestParam(value = "id", required = true) Long productId, Model model, HttpServletRequest request) {
        String rootDirectory = new File("").getAbsolutePath();
